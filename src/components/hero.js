    ...
    return (
        <section className='flex flex-col items-center gap-10 py-16'>
            <div className='flex max-xl:flex-col items-center gap-12 xl:gap-20'>
                <div className='text-center max-md:px-8 md:w-[700px]'>
                    <h1 className='font-light md:text-xl tracking-widest'>
                        DRONE RESEARCH AND INTELLIGENT FLIGHT TECHNOLOGY
                    </h1>
                    <h2 className='font-semibold text-xl md:text-5xl my-3 md:my-5'>
                        Award winning <span className='text-blue'>undergraduate</span> autonomous drone research.
                    </h2>
                ...
                <div className='w-full aspect-square xs:w-[400px] xs:h-[400px] bg-neutral-300' />
            </div>
